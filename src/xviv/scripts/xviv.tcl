...
proc cmd_synthesis {top_module} {
	...
	exec ln -sf "$out_dir/${top_module}_${dirty}_${sha_short}.xsa" "$out_dir/${top_module}.xsa"
	exec ln -sf "$out_dir/${top_module}_${dirty}_${sha_short}.bit" "$out_dir/${top_module}.bit"
