...
from xviv.functions.simulation import cmd_snapshot_open, cmd_wdb_open


class OpenCommand(Command):
	name = "open"
	help = "Open a checkpoint, simulation snapshot, or waveform DB"

	@classmethod
	def register(cls, sub: argparse._SubParsersAction) -> None:
		c = sub.add_parser(cls.name, help=cls.help)

		# What to open: exactly one of --dcp / --snapshot / --wdb
